...
$(function () {
    ...
    table = $('#lecture').DataTable({
        ...
        "order": [], //Initial no order.
        "ajax": {
            "url": site_url + uri_seg_1 + '/' + uri_seg_2 + '/ajax_lectue_list',
            "type": "POST",
            "data": {
                'csrf_token': csrf_token, 'id': uri_seg_4
            },
        },                      // Load data for the table's content from an Ajax source
        "columnDefs": [{
            "targets": [0, -1], //first & last column
    ...
    table = $('#users_course').DataTable({
        ...
        "order": [], //Initial no order.
        "ajax": {
            "url": site_url + uri_seg_1 + '/' + uri_seg_2 + '/ajax_users_list',
            "type": "POST",
            "data": {
                'csrf_token': csrf_token, 'id': uri_seg_4
            },
