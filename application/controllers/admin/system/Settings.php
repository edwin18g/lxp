...
class Settings extends Admin_Controller
{
    ...
    function index()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!empty($_FILES['promo_modal_image']['name'])) // if promo_modal_image
            {
                $file_image = array('folder' => 'home', 'input_file' => 'promo_modal_image', 'filename' => 'promo_modal_image', 'format' => 'jpg|JPG|png|PNG');
        ...
        // load views
        $content['content'] = $this->load->view('admin/system/settings/form', $data, TRUE);
