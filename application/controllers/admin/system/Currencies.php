...
class Currencies extends Admin_Controller
{
    ...
    function index()
    {
        ...
        // load views
        $content['content'] = $this->load->view('admin/system/index', $data, TRUE);
    ...
    public function form($iso_code = NULL)
    {
        ...
        /* Load Template */
        $content['content'] = $this->load->view('admin/system/currencies/form', $data, TRUE);
        $this->load->view($this->template, $content);
    }
    ...
    public function view($iso_code)
    {
        ...
        /* Load Template */
        $content['content'] = $this->load->view('admin/system/currencies/view', $data, TRUE);
        $this->load->view($this->template, $content);
    }
