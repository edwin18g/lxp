...
class Bbookings extends Admin_Controller
{
    ...
    function index()
    {
        ...
        // load views
        $content['content'] = $this->load->view('admin/lms/index', $data, TRUE);
    ...
    public function form($id = NULL)
    {
        ...
        /* Load Template */
        $content['content'] = $this->load->view('admin/lms/b_bookings/form', $data, TRUE);
        $this->load->view($this->template, $content);
    ...
    public function view($id = NULL, $print = NULL)
    {
        ...
        /* Load Template */
        if ($print) {
            $this->load->view('admin/lms/b_bookings/view_invoice', $data);
        } else {
            $content['content'] = $this->load->view('admin/lms/b_bookings/view', $data, TRUE);
            $this->load->view($this->template, $content);
        }
    }
    ...
    function get_booked_seats()
    {
        ...
        echo json_encode(array('booked_seats' => $result));
        exit;
    }
