...
class Sliders extends Admin_Controller
{
    ...
    function index()
    {
        ...
        // load views
        $content['content'] = $this->load->view('admin/sliders/index', $data, TRUE);
    ...
    public function form($id = NULL)
    {
        ...
        /* Load Template */
        $content['content'] = $this->load->view('admin/sliders/form', $data, TRUE);
        $this->load->view($this->template, $content);
    }
    ...
    public function view($id = NULL)
    {
        ...
        /* Load Template */
        $content['content'] = $this->load->view('admin/sliders/view', $data, TRUE);
        $this->load->view($this->template, $content);
    }
