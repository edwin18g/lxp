...
class Ebookings extends Admin_Controller
{
    ...
    function index()
    {
        ...
        // load views
        $content['content'] = $this->load->view('admin/events/index', $data, TRUE);
    ...
    public function form($id = NULL)
    {
        ...
        /* Load Template */
        $content['content'] = $this->load->view('admin/events/e_bookings/form', $data, TRUE);
        $this->load->view($this->template, $content);
