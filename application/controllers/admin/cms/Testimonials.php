...
class Testimonials extends Admin_Controller
{
    ...
    public function form($id = NULL)
    {
        ...
        /* Load Template */
        $content['content'] = $this->load->view('admin/cms/testimonials/form', $data, TRUE);
        $this->load->view($this->template, $content);
    }
    ...
    public function save()
    {
        ...
        $this->form_validation
            ...
            ->set_rules('t_feedback', lang('testimonials_feedback'), 'trim|required|min_length[2]|max_length[1000]')
    ...
    public function view($id = NULL)
    {
        ...
        /* Load Template */
        $content['content'] = $this->load->view('admin/cms/testimonials/view', $data, TRUE);
        $this->load->view($this->template, $content);
    }
