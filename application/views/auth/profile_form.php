    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center image-card">
                <div class="picture-container">
                    <div class="picture">
                        <img src="<?php echo (isset($user['image']) && $user['image']) ? base_url('upload/users/images/') . $user['image'] : base_url('themes/default/images/avatar.jpg'); ?>"
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <?php else: ?>
                    <p><input type="checkbox" name="vehicle" value="Bike" required> I agree to the Terms and
                        Conditions<br>The content,videos, and materials belongs to the Z-eyobron. If you involve in sharing
                        any of these videos or content will be subjected to pay the Penalty of 1 lakh rupees. Also, once the
                        access is provided cannot be revoked and will not be subjected to any refund</p>
                    <button type="submit" name="submit_form" id="submit_form"
                        class="btn"><?php echo lang('users_register'); ?></button>
                <?php endif; ?>
            </div>
        </div>
        <?php echo form_close(); ?>
        ...
        <?php if (!$this->session->userdata('logged_in')): ?>
            ...
            <?php if ($this->settings->fb_app_id && $this->settings->fb_app_secret) { ?>
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="<?php echo site_url('auth/f_register') ?>"
                            class="btn loginBtn loginBtn--facebook"><span><?php echo lang('users_login_continue_fb') ?></span></a>
            ...
            <?php if ($this->settings->g_client_id && $this->settings->g_client_secret) { ?>
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="<?php echo site_url('auth/g_register') ?>"
                            class="btn loginBtn loginBtn--google"><span><?php echo lang('users_login_continue_g') ?></span></a>
