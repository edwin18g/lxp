        ...
        <div class="card">
            <div class="header"
                ...
                <div class="header-dropdown m-r--5">
                    ...
                    <!-- Delete Button -->
                    <?php echo '<a role="button" onclick="ajaxDelete(' . $users->id . ', `' . mb_substr($users->first_name . ' ' . $users->last_name, 0, 30, 'utf-8') . '`, `' . lang('menu_user') . '`)" class="btn btn-default btn-circle waves-effect waves-circle waves-float" title="Delete"><i class="material-icons">delete_forever</i></a>'; ?>
                </div>
            </div>
                ...
                <table class="table table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $users->gender == 'male' ? lang('users_gender_male') : ($users->gender == 'female' ? lang('users_gender_female') : lang('users_gender_other')); ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo ($users->active) ? '<span class="label label-success">' . lang('common_status_active') . '</span>' : '<span class="label label-default">' . lang('common_status_inactive') . '</span>'; ?>
                            </td>
                        </tr>
                        <tr>
