    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="<?php echo site_url().'admin/'.$this->uri->segment(2).'/lecture_form/'.$this->uri->segment(4); ?>" class="btn bg-<?php echo $this->settings->admin_theme ?> btn-circle waves-effect waves-circle waves-float pull-right">
