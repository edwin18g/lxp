...
<section class="pad-none parallax-bg hero">
    <div class="owl-carousel  dots-inline" 
        ...
        data-autoplay="true" 
        data-delay="3000" 
        data-navigation="false" style="height: 450px;
    overflow: hidden;-webkit-clip-path: polygon(0 0, 100% 0, 100% 90%, 48% 100%, 0 89%);
clip-path: polygon(0 0, 100% 0, 100% 90%, 48% 100%, 0 89%);"
    >
    
        <?php for($i = 1; $i<=3;$i++) { if($this->settings->{'banner_title_'.$i}) { ?>
        <div class="item typo-light" style="height: 450px;background:url(<?php echo base_url('upload/home/').$this->settings->{'banner_image_'.$i} ?>);background-size: cover;background-position: center;">
    ...
    background: linear-gradient(261deg, rgba(94,89,89,0) 0%, rgb(0, 38, 84) 81%, rgb(3, 31, 64) 100%);
    height: 450px;
    padding: 100px 0px 0px 100px;
">
                <div class="">
                    <div>
                        <h3 class="text-uppercase" style="font-size: 40px;
    font-weight: 600;
    line-height: 1.33;" data-animation="fadeInUp" ><?php echo $this->settings->{'banner_title_'.$i} ?></h3>
